...
import {  UseUpdateProject } from '../../Hooks/ProjectsHooks'
...
const AdminEditProject = () => {
    //get project data
    const {id}=useParams();
    const [img,name,onChangeName,onChangeImage,setImg,description,onChangeDecription,onImageChange,handelupdate,response, Loading]=UseUpdateProject(id);
